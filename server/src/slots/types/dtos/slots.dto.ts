...
export class UpdateSlotTimesDto {
  @ApiProperty({
    ...
    description: 'New start datetime (YYYY-MM-DDThh:mm:ss)',
  })
  @IsDateString()
  start: string;

  @ApiProperty({
    example: '2026-02-23T11:30:00',
    description: 'New end datetime (YYYY-MM-DDThh:mm:ss)',
  })
  @IsDateString()
  end: string;
}
